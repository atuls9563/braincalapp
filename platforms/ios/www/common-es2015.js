...
let QuizService = class QuizService {
    ...
    getQuizes() {
        ...
        return this.http.get(_shared_app_constants__WEBPACK_IMPORTED_MODULE_2__["AppConstants"].QUIZ_URL + 'quiz_names').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(data => data));
    }
    getQuestions(id) {
        // return this.http.get(AppConstants.QUIZ_URL + 'questions/' + id).map(data=> data.json());
        return this.http.get(_shared_app_constants__WEBPACK_IMPORTED_MODULE_2__["AppConstants"].QUIZ_URL + 'questions/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(data => data));
    }
};
QuizService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
];
QuizService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
