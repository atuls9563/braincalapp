...
const routes = [
    ...
    {
        path: 'trick',
        loadChildren: () => Promise.all(/*! import() | pages-trick-trick-module */[__webpack_require__.e("default~pages-el-plus-el-plus-module~pages-trick-trick-module"), __webpack_require__.e("pages-trick-trick-module")]).then(__webpack_require__.bind(null, /*! ./pages/trick/trick.module */ "./src/app/pages/trick/trick.module.ts")).then(m => m.TrickPageModule)
    },
    {
        path: 'folder/:id',
    ...
    {
        path: 'maths',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-maths-maths-module */ "pages-maths-maths-module").then(__webpack_require__.bind(null, /*! ./pages/maths/maths.module */ "./src/app/pages/maths/maths.module.ts")).then(m => m.MathsPageModule)
    },
    {
        path: 'lang-list',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-lang-list-lang-list-module */ "pages-lang-list-lang-list-module").then(__webpack_require__.bind(null, /*! ./pages/lang-list/lang-list.module */ "./src/app/pages/lang-list/lang-list.module.ts")).then(m => m.LangListPageModule)
    },
    {
        path: 'lang-cat',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-lang-cat-lang-cat-module */ "pages-lang-cat-lang-cat-module").then(__webpack_require__.bind(null, /*! ./pages/lang-cat/lang-cat.module */ "./src/app/pages/lang-cat/lang-cat.module.ts")).then(m => m.LangCatPageModule)
    },
    {
        path: 'lang',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-lang-lang-module */ "pages-lang-lang-module").then(__webpack_require__.bind(null, /*! ./pages/lang/lang.module */ "./src/app/pages/lang/lang.module.ts")).then(m => m.LangPageModule)
    },
    {
        path: 'quiz',
        loadChildren: () => Promise.all(/*! import() | pages-quiz-quiz-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-quiz-quiz-module")]).then(__webpack_require__.bind(null, /*! ./pages/quiz/quiz.module */ "./src/app/pages/quiz/quiz.module.ts")).then(m => m.QuizPageModule)
    },
    {
        path: 'quizes',
        loadChildren: () => Promise.all(/*! import() | pages-quizes-quizes-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-quizes-quizes-module")]).then(__webpack_require__.bind(null, /*! ./pages/quizes/quizes.module */ "./src/app/pages/quizes/quizes.module.ts")).then(m => m.QuizesPageModule)
    },
    {
        path: 'el-plus-cat/:type',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-el-plus-cat-el-plus-cat-module */ "pages-el-plus-cat-el-plus-cat-module").then(__webpack_require__.bind(null, /*! ./pages/el-plus-cat/el-plus-cat.module */ "./src/app/pages/el-plus-cat/el-plus-cat.module.ts")).then(m => m.ElPlusCatPageModule)
    },
    {
        path: 'el-plus-list',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-el-plus-list-el-plus-list-module */ "pages-el-plus-list-el-plus-list-module").then(__webpack_require__.bind(null, /*! ./pages/el-plus-list/el-plus-list.module */ "./src/app/pages/el-plus-list/el-plus-list.module.ts")).then(m => m.ElPlusListPageModule)
    },
    {
        path: 'el-plus',
        loadChildren: () => Promise.all(/*! import() | pages-el-plus-el-plus-module */[__webpack_require__.e("default~pages-el-plus-el-plus-module~pages-trick-trick-module"), __webpack_require__.e("pages-el-plus-el-plus-module")]).then(__webpack_require__.bind(null, /*! ./pages/el-plus/el-plus.module */ "./src/app/pages/el-plus/el-plus.module.ts")).then(m => m.ElPlusPageModule)
    },
    {
        path: 'favorites',
    ...
    {
        path: 'feedback',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-feedback-feedback-module */ "pages-feedback-feedback-module").then(__webpack_require__.bind(null, /*! ./pages/feedback/feedback.module */ "./src/app/pages/feedback/feedback.module.ts")).then(m => m.FeedbackPageModule)
    }
];
const newpath = [
    {
        path: '',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./app.module */ "./src/app/app.module.ts")).then(m => m.AppModule)
    }
];
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, storage, userService, router, menuCtrl) {
...
/* harmony import */ var _ionic_native_in_app_purchase_ngx__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @ionic-native/in-app-purchase/ngx */ "./node_modules/@ionic-native/in-app-purchase/__ivy_ngcc__/ngx/index.js");
...
/* harmony import */ var _ionic_native_sign_in_with_apple_ngx__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @ionic-native/sign-in-with-apple/ngx */ "./node_modules/@ionic-native/sign-in-with-apple/__ivy_ngcc__/ngx/index.js");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            _ionic_native_in_app_purchase_ngx__WEBPACK_IMPORTED_MODULE_12__["InAppPurchase"],
            Storage,
...
/* harmony import */ var rxjs_add_operator_mergeMap__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rxjs/add/operator/mergeMap */ "./node_modules/rxjs/add/operator/mergeMap.js");
...
let UserService = class UserService {
    ...
    doLogin(mobile, countryCode) {
        // return this.getRegisterNonce().flatMap((data)=> this.doRegisterLogin(data.json(),mobile,countryCode)).map(response=>response.json());
        return this.getRegisterNonce().flatMap((data) => this.doRegisterLogin(data, mobile, countryCode)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(response => response));
    }
    getRegisterNonce() {
        return this.http.get(_shared_app_constants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].REG_NONCE_URL);
    }
    verifyOTP(mobile, countryCode, otp, otp_session) {
        let url = _shared_app_constants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].CUSTOM_REG_URL + "?mobile=" + mobile + "&countryCode=" + countryCode + "&otp_session=" + otp_session + "&otp=" + otp;
        // return this.sendOTP(url).map(response=>response.json());
        return this.sendOTP(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(response => response));
    }
    sendOTP(url) {
        return this.http.get(url);
    }
    doRegisterLogin(data, mobile, countryCode) {
        let url = _shared_app_constants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].CUSTOM_REG_URL + "?mobile=" + mobile + "&countryCode=" + countryCode + "&nonce=" + data.nonce;
        return this.http.get(url);
    }
    ...
    // }
    saveFavorites(favorites, cookie) {
        let requestData = {
            cookie: cookie,
            meta_key: 'favorites',
            meta_value: favorites.map(Number).toString()
        ...
        // return this.http.post(AppConstants.UPDATE_PROFILE,JSON.stringify(requestData)).map(data=>data.json());
        // return this.http.post(AppConstants.UPDATE_PROFILE,JSON.stringify(requestData)).pipe(map(data=>data));
        return this.http.post(_shared_app_constants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].UPDATE_PROFILE, JSON.stringify(requestData));
        // .pipe(map(data=>
        //     {
        //         console.log(data);
    ...
    updateUser(user, cookie) {
        ...
        // return this.http.post(AppConstants.UPDATE_PROFILE,JSON.stringify(requestData)).map(data=>data.json());
        return this.http.post(_shared_app_constants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].UPDATE_PROFILE, JSON.stringify(requestData)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(data => data));
    }
    logout() {
        this.storage.remove('authCookie');
        this.storage.remove('userData');
    }
    registerUser(email, username, first_name = '') {
        let requestData = {
            email: email,
        ...
        return this.http.post(_shared_app_constants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].REG_URL, JSON.stringify(requestData)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(data => data));
    }
};
...
module.exports = __webpack_require__(/*! /Volumes/storage/Projects/braincal/New code base 22-june/src/main.ts */"./src/main.ts");
