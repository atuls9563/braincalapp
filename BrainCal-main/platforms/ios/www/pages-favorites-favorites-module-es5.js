(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-favorites-favorites-module"], {
    /***/
    "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/favorites/favorites.page.html": function node_modulesRawLoaderDistCjsJsSrcAppPagesFavoritesFavoritesPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    "./src/app/pages/favorites/favorites-routing.module.ts": function srcAppPagesFavoritesFavoritesRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    "./src/app/pages/favorites/favorites.module.ts": function srcAppPagesFavoritesFavoritesModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    "./src/app/pages/favorites/favorites.page.scss": function srcAppPagesFavoritesFavoritesPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    "./src/app/pages/favorites/favorites.page.ts": function srcAppPagesFavoritesFavoritesPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var FavoritesPage = /*#__PURE__*/function () {
        function FavoritesPage(userService, service, alertCtrl, router) {
        ...
        _createClass(FavoritesPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.userService.getUser().then(function (user) {
              var ids = user.favorites.toString().split(',');
              _this.userFavorites = ids.map(Number);

              _this.showRequestInProgress(true);

              _this.service.getPostsByIds(user.favorites).subscribe(function (posts) {
                _this.showRequestInProgress(false);

                _this.posts = posts;
              }, function (err) {
                _this.showRequestInProgress(false);

                _this.checkForResponseError(err);
              });
            });
          }
        }, {
          ...
          key: "openDetailPage",
          value: function openDetailPage(post) {
            if (post.type == 'tricks') {
              ...
              this.router.navigate(['gk'], _navigationExtras);
              ...
              this.router.navigate(['el-plus'], _navigationExtras2);
              ...
              this.router.navigate(['lang'], _navigationExtras3);
            }
          }
        }, {
          key: "searchTrick",
          value: function searchTrick() {
            ...
            if (this.searchKeyword) {
              if (this.searchKeyword.length < 3) return false;
              this.service.searchPosts(this.searchKeyword).subscribe(function (posts) {
                _this2.postSuggestions = posts;
              }, function (err) {
          ...
          value: function doInfinite(infiniteScroll) {
            ...
            if (page < 5) {
              this.userService.getUser().then(function (user) {
                ...
                _this3.service.getPostsByIds(ids, page).subscribe(function (tricks) {
                  _this3.posts = _this3.posts.concat(tricks);
          ...
          key: "removeFavorite",
          value: function removeFavorite(id, itemIndex) {
            this.posts.splice(itemIndex, 1);
            var tmpIndex = this.userFavorites.indexOf(id);
